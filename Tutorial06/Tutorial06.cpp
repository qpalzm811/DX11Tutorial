...
void Render()
{
    ...
    // Rotate cube around the origin绕着原点转动
	g_World = XMMatrixRotationY( t );

    // Setup our lighting parameters更新光的参数
    ...
    // Rotate the second light around the origin 第二个光绕着原点转动
    ...
    //
    float ClearColor[4] = { 0.5f, 0.925f, 0.3f, 0.1f }; // red, green, blue, alpha
